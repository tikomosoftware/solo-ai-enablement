# Claude Codeをチームで安全に使うための「AI Development Harness」を作った話

## はじめに

社内でAI活用を進めるにあたって、最初は「AIとは何か」「AIを業務でどう使うか」という啓蒙記事を作るところから始めました。
...
最初はAI啓蒙記事の相談から始まり、OneNote運用、GitHubリポジトリ化、HTML生成、Claude Code安全設定、そしてTeam AI Development Harnessへと育っていきました。
...
これからClaude CodeやGitHub Copilotをチームで使う人の参考になればうれしいです。
