...
このページは、HTMLで資料を説明するときの入口です。

初めて説明する場合は、すべてを一度に扱わず、基礎・ルール編、実用編、リファレンス、ツール別ガイドの順に必要な範囲だけ選びます。

## 作成状況について

**注意:** 後半の実用編、リファレンス、ツール別ガイドは、現在は構成と章立てを確認するための下書きが中心です。各ページにはインデックスと簡単な要点がありますが、詳細な手順、画面例、実プロジェクトでの具体例はまだ作成中です。

このページでは、完成済みの読み物としてではなく、今後どの章を深掘りするかを選ぶための地図として案内します。

## まず説明する範囲

初回説明会や最初の共有では、次の範囲に絞ります。

- AI開発支援の考え方
- AI開発利用ポリシー
- ツールの使い分け
- VS CodeでClaude Codeを使う準備
- Claude Code初回セットアップ
- 最初の実践課題
- 承認が必要な操作
- Claude Code強機能の扱い方
...
初回説明では、Hooks、MCP、サブエージェント、外部連携、長時間の自動作業、自動コミット、自動pushを詳しく扱いません。

これらは便利な機能ですが、チームの権限、レビュー方法、失敗時の止め方を決めてから扱います。
