...
ここでは厳密な製品仕様よりも、業務で使うときの理解しやすさを優先しています。
...
`bypassPermissions` は、通常の業務リポジトリでは使いません。
...
一方で、プロジェクト固有のデプロイ手順、社内独自のレビュー観点、独自ライブラリの使い方は、運用しながらノウハウが溜まってからSkill化する方が自然です。
